...
```bash
crontab -l
tail -n 50 /home/ubuntu/halle_bot/cron.log
```
...
```bash
*/10 * * * * cd /home/ubuntu/halle_bot && /home/ubuntu/halle_bot/venv/bin/python /home/ubuntu/halle_bot/run_check_once.py >> /home/ubuntu/halle_bot/cron.log 2>&1
```
